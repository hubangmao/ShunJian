 ...
 */
public class HairDressertPopupwindow implements OnItemClickListener {
	...
	public HairDressertPopupwindow(Context context, FrameLayout parent) {
		super();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(context).inflate(
						R.layout.item_hair_dreessert_popupwindow_layout, null);
