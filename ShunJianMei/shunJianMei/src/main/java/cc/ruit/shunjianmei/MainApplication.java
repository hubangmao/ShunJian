...
//	static public boolean isEnd = false;
    /**
     *
     */
...
//		initYouMi();
    ...
    public void init(Activity activity, Handler handler) {
        ...
        FileConstant constant = new FileConstant(
                "/data/data/cc.ruit.shunjianmei/first/", "/shunjianmei",
                "/shunjianmei/download/", "/shunjianmei/temp/",
                "/data/data/cc.ruit.shunjianmei/temp/", "",
                "/shunjianmei/upload/", "", "");
